describe('hashTable', function () {
  ...
  it('should retrieve the stored value of the key, not return the key name', function () {
    hashTable.insert('Kim', 'Impossible');
    expect(hashTable.retrieve('Kim')).to.equal('Impossible');
  });
